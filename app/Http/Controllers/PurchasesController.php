...
class PurchasesController extends Controller
{
    ...
    public function show_all_bills($paginationVal,Request $request){
        ...
        //$paid_amounts = new PurchaseBill();
        //$paid_amount = $paid_amounts->bill_payments();
    ...
    public function return_bill_list(){
        $return_bill = ReturnPurchaseBill::with('bill')->with('return_products')->with('user')->get();
        return view('admin.purchase.purchasereturnbill',compact('return_bill'));
    }
