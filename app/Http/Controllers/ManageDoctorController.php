...
class ManageDoctorController extends Controller
{
    ...
    public function show_all_doctors($paginationVal){
        $doctors = Doctor::paginate($paginationVal);
    ...
    public function show_all_prescription_bill($paginationVal,Request $request){
        /*$pres_bills = SaleBill::has('prescription')->with('prescription')->with('user')->with('customer')->paginate(100);
        return $pres_bills;*/
