...
<script>
  ...
  function set_product(data){
    ...
    '<td><input type="date" name="multi_production_date[]"class="form-control" required/></td>'+
    ...
    '<td><input type="number" name="multi_discount[]"  class="form-control" value="0" id="discount'+i+'" onChange="pro_total_pruce('+i+')" onkeyup="this.onchange();" onpaste="this.onchange();" oninput="this.onchange();" required/></td>'+
