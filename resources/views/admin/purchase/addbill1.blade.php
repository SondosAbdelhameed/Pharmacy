...
<div class="table-responsive">
        ...
        <th>ملاحظات</th>
            ...
            <tr>  
				...
				<td><input type="number" step="0.001" name="multi_total[]"  class="form-control" id="pro_total0" readonly/></td>
