    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="number" step="0.001" min="1" max="{{$return_bill->total_amount - $return_bill->return_payments()->sum('paid_amount')}}" class="form-control" name="amount_val" required>
        </div>
        <!--<div class="form-group">
